...
void test_validate_my_username()
{
    ...
    char *user_name_malloc = malloc_username_from_conf_file();
     
    //TEST_ASSERT_TRUE_MESSAGE(false,"AESD students, please fix me!");
    TEST_ASSERT_EQUAL_STRING_MESSAGE(user_name,user_name_malloc,"Username is bmoghram");

    // free(user_name_malloc);
}
